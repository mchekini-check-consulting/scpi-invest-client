...
export class ScpiPerformanceSimulationComponent  implements OnInit, OnChanges {
  ...
  @Input("futureIncomesEveryFiveYears") futureIncomesEveryFiveYears!: Map<number,{ incomes: number, revaluation: number, initialInvestment: number, total: number, averageRate: number }>;
